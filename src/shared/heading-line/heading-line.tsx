...
import {IHeadingLine} from "@/shared/heading-line/data-types/heading-line";
    ...
    return (
        <div className={css.heading}>
            ...
            <Link href={`/`} className={`${css.link} ${!count ? css.hide : ''}`}>
                ...
                <svg className={css.icon} width="24" height="24" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
