...
import ProductRate from "@/shared/product/components/product-info/product-rate/product-rate";
import {IProduct} from "@/data-types/products/products";
import ProductPrice from "@/shared/product/components/product-info/product-price/product-price";
