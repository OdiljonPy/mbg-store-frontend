...
import DeliverySwitch from "@/components/pages/products/filters/delivery/delivery-switch/delivery-switch";
...
import DeliveryItem from "@/components/pages/products/filters/delivery/delivery/delivery";
