...
function PasswordInput({ setPassword, isValid, setIsValid }: Props) {
	const [showPassword, setShowPassword] = useState(false);
	const [passwordRequirements, setPasswordRequirements] = useState(
		passwordRequirementData
	);
	...
	useEffect(() => {
		setIsValid(
			!passwordRequirements?.map((item) => item.isValid).includes(false)
		);
	});
