...
import css from './navigation-btn.module.css'
...
const NavigationBtn = ({isNext, onClick}: props) => {
    return (
        <button onClick={onClick} className={`${css.btn} ${isNext ? css.next : ''}`}>
            <svg className={css.icon} width="26" height="26" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
