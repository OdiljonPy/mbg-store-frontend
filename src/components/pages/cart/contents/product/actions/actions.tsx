...
const Actions = ({ setCount, count, product, isAvailable }: props) => {
  ...
  return (
    <>
      {isAvailable ? (
        <div className={css.action_available}>
          <Badge
            text={t("product.has_not")}
            color={"#F2F2F2"}
            className={cn(css.custom_badge)}
          />
          <div className={css.available_saved}>
        ...
        <div className={css.actions}>
          <div className={css.action}>
            ...
            {!isAvailable ? <ClientAddToFav product={product} /> : ""}
          </div>
          {available > 1 && (
            <button
              type={"button"}
