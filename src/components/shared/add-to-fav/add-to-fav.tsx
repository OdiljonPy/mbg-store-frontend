...
const AddToFav = ({ product }: props) => {
	...
	console.log(product.featured_product);

	const debouncedIsFavorite = useDebounce(isFavorite, 500);

	const dispatch = useDispatch<AppDispatch>();

	// this is to prevent useEffect from running on first render and do not send request to server to post favorite
