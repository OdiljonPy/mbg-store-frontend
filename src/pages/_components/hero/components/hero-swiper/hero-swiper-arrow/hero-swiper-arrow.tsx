...
import css from './hero-swiper-arrow.module.css'
...
const HeroSwiperArrow = ({isNext, onClick}: props) => {
    return (
        <button onClick={onClick} className={`${css.btn} ${isNext ? css.btnNext : ''}`}>
            <svg className={`${css.icon} ${isNext ? css.iconNext : ''} `} width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default HeroSwiperArrow;